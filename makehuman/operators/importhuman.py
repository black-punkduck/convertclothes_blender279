...
class MHC_OT_ImportHumanOperator(bpy.types.Operator, ImportHelper):
    ...
    def execute(self, context):
        ...
        return import_obj.load(context, self.properties.filepath, use_split_objects=False, use_split_groups=False, use_groups_as_vgroups=True, global_matrix=global_matrix)
